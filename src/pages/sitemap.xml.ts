...
const staticPages = [
  ...
  { url: '/clubhouse/menus', priority: '0.7', changefreq: 'monthly' },
  { url: '/clubhouse/sunday-menu', priority: '0.6', changefreq: 'monthly' },
  { url: '/clubhouse/sunday-bar-menu', priority: '0.6', changefreq: 'monthly' },
